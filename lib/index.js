(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Libtest5"] = factory();
	else
		root["Libtest5"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.MP4FileSelectorReducers = exports.MP4FileSelector = exports.MP4FileInput = undefined;

	var _FileInput = __webpack_require__(1);

	var _FileInput2 = _interopRequireDefault(_FileInput);

	var _MP4Selector = __webpack_require__(72);

	var _MP4Selector2 = _interopRequireDefault(_MP4Selector);

	var _reducers = __webpack_require__(82);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var MP4FileInput = exports.MP4FileInput = _FileInput2.default; // for test use
	var MP4FileSelector = exports.MP4FileSelector = _MP4Selector2.default;

	var MP4FileSelectorReducers = exports.MP4FileSelectorReducers = {
	  files: _reducers.files,
	  checked: _reducers.checked
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NaiveFileInput = function NaiveFileInput(_ref) {
	...
	exports.default = (0, _reactRedux.connect)(null, mapDispatchToProps)(NaiveFileInput);
...
/***/ function(module, exports) {
	...
	var SET_THUMBNAIL = exports.SET_THUMBNAIL = 'SET_THUMBNAIL';
	...
	var setThumbnail = exports.setThumbnail = function setThumbnail(id, url) {
	  return {
	    type: SET_THUMBNAIL,
	    id: id,
	    url: url
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MP4Thumbnail = __webpack_require__(74);

	var _MP4Thumbnail2 = _interopRequireDefault(_MP4Thumbnail);
	...
	var MP4InputLabel = function MP4InputLabel(_ref) {
	  var file = _ref.file,
	      checked = _ref.checked;
	  return _react2.default.createElement(
	    'label',
	    null,
	    _react2.default.createElement(_MP4Thumbnail2.default, { file: file,
	      checked: checked })
	  );
	};

	var MP4Input = function MP4Input(_ref2) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(MP4InputLabel, { file: file,
	      checked: checked }),
	...
	var NaiveMP4Selector = function NaiveMP4Selector(_ref3) {
	  var files = _ref3.files,
	      checked = _ref3.checked;
	  return _react2.default.createElement(
	    'div',
	    { className: css.mp4Selector },
	    files.filter(function (file) {
	      return (0, _utils.isMP4)(file.blob.name);
	    }).map(function (file) {
	      return _react2.default.createElement(MP4Input, { key: file.id,
	        file: file,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, null)(NaiveMP4Selector);
...
/***/ function(module, exports) {
	...
	var genKey = exports.genKey = getTimestamp;
	...
	var mp4Regex = /\.mp4/;
	var isMP4 = exports.isMP4 = genValidator(mp4Regex);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WIDTH = config.thumbnail.width;
	var HEIGHT = config.thumbnail.height;
	...
	var NaiveMP4Thumbnail = function (_React$Component) {
	  _inherits(NaiveMP4Thumbnail, _React$Component);

	  function NaiveMP4Thumbnail() {
	    _classCallCheck(this, NaiveMP4Thumbnail);

	    return _possibleConstructorReturn(this, (NaiveMP4Thumbnail.__proto__ || Object.getPrototypeOf(NaiveMP4Thumbnail)).apply(this, arguments));
	  }

	  _createClass(NaiveMP4Thumbnail, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      video.src = URL.createObjectURL(this.props.file.blob);

	      var onDrawImage = this.props.onDrawImage;
	      video.addEventListener(LOADED_DATA, function () {
	        canvas.width = video.videoWidth;
	        canvas.height = video.videoHeight;

	        canvas.getContext(DIM2).drawImage(video, 0, 0);

	        _this2._canvas = canvas;
	        _this2._video = video;

	        video.currentTime = 0;
	        onDrawImage(canvas.toDataURL(JPEG));
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var src = this.props.file.thumbnail;
	      var checked = this.props.checked;
	      var className = checked ? css.mp4ThumbnailChecked : css.mp4Thumbnail;
	      var onClick = this.props.onClick;
	      return _react2.default.createElement('img', { role: 'presentation',
	        src: src,
	        className: className,
	        width: WIDTH,
	        height: HEIGHT,
	  ...
	  return NaiveMP4Thumbnail;
	}(_react2.default.Component);

	var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
	  var id = ownProps.file.id;
	  return {
	    onDrawImage: function onDrawImage(url) {
	      return dispatch((0, _actions.setThumbnail)(id, url));
	    },
	...
	exports.default = (0, _reactRedux.connect)(null, mapDispatchToProps)(NaiveMP4Thumbnail);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js?importLoaders=1!./../../../node_modules/postcss-loader/index.js!./MP4Thumbnail.css", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js?importLoaders=1!./../../../node_modules/postcss-loader/index.js!./MP4Thumbnail.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js?importLoaders=1!./../../../node_modules/postcss-loader/index.js!./MP4Selector.css", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js?importLoaders=1!./../../../node_modules/postcss-loader/index.js!./MP4Selector.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.checked = exports.files = undefined;
	...
	var checked = exports.checked = function checked() {
